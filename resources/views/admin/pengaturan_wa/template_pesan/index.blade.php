            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Template Pesan</h3>
                ...
                <form id="formData">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="nama_template" class="col-sm-3 col-form-label">Nama Template</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="isi_template" class="col-sm-3 col-form-label">Username</label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" id="isi_template" name="isi_template" rows="3"></textarea>
                            </div>
                        </div>

                        <div class="row mb-3 align-items-center">
                            <label for="jenis_pesan" class="col-sm-3 col-form-label">Jenis Pesan</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="jenis_pesan" name="jenis_pesan">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                ordering: false,
                responsive: true,
                ajax: "{{ route('template-pesan.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.get(url, function(response) {
                if (response.success) {
                    ...
                    $('#isi_template').val(response.data.isi_template);
                    $('#jenis_pesan').val(response.data.jenis_pesan);
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('template-pesan.update', ['template_pesan' => ':id']) }}'.replace(':id',
                    id) :
                '{{ route('template-pesan.store') }}';
