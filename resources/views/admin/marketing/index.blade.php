            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Data Marketing</h3>
                        <div class="d-flex align-items-center">
                            @if (isset($permissions['tambah']) && $permissions['tambah'] == 1)
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalForm">
                                    <i class="bi bi-plus-lg"></i> Tambah Marketing
                                </button>
                            @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalFormLabel">Form Marketing</h5>
...
@push('scripts')
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'kode_marketing_render',
                        name: 'kode_marketing_render',
                    },
                    {
                        data: 'nama_marketing',
                        name: 'nama_marketing',
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('marketing.update', ['marketing' => ':id']) }}'.replace(':id',
                    id) :
