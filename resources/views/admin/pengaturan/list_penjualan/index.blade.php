            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">List Progres Penjualan</h3>
                ...
                <form id="formData">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="status_progres" class="col-sm-3 col-form-label">Progres Penjualan</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="status_progres" name="status_progres">
                            </div>
                        </div>

                        <div class="row mb-3 align-items-center">
                            <label for="short_name" class="col-sm-3 col-form-label">Nama Singkat</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="stt_tampil" class="col-sm-3 col-form-label">Status</label>
                            <div class="col-sm-5">
                                <select class="form-select select-status" id="stt_tampil" name="stt_tampil">
                                    <option value=""></option>
...
@push('scripts')
    <script>
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('list-penjualan.update', ['list_penjualan' => ':id']) }}'.replace(':id',
                    id) :
